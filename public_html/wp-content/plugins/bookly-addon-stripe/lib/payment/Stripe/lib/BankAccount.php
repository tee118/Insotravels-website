 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Customer $customer The ID of the customer that the bank account is associated with.
