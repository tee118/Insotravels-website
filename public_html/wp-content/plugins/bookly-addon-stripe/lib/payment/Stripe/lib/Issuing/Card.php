 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $spending_controls
...
class Card extends \BooklyStripe\Lib\Payment\Lib\Stripe\ApiResource
{
     ...
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Issuing\CardDetails the card details associated with that issuing card
     */
