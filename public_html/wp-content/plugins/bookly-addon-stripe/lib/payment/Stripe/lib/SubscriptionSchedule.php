 ...
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\BooklyStripe\Lib\Payment\Lib\Stripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $default_settings
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 */
