 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Issuing\Authorization $authorization The <code>Authorization</code> object that led to this transaction.
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\BalanceTransaction $balance_transaction ID of the <a href="https://stripe.com/docs/api/balance_transactions">balance transaction</a> associated with this transaction.
 * @property string|\BooklyStripe\Lib\Payment\Lib\Stripe\Issuing\Card $card The card used to make this transaction.
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Issuing\Cardholder $cardholder The cardholder to whom this transaction belongs.
 ...
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $purchase_details Additional purchase information that is optionally provided by the merchant.
