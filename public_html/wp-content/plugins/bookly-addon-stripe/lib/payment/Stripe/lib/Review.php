 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Charge $charge The charge associated with this review.
 ...
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property string|\BooklyStripe\Lib\Payment\Lib\Stripe\PaymentIntent $payment_intent The PaymentIntent ID associated with this review, if one exists.
 ...
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $session Information related to the browsing session of the user who initiated the payment.
 */
