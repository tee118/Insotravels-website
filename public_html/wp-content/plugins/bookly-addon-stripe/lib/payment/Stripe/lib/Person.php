 ...
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $dob
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $relationship
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $verification
 */
