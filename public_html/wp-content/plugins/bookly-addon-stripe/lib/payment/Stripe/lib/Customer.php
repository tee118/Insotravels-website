 ...
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $address The customer's address.
 ...
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $invoice_settings
 ...
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\Collection $sources The customer's payment sources, if any.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\Collection $subscriptions The customer's current subscriptions, if any.
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\Collection $tax_ids The customer's tax IDs.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Customer the updated customer
     */
     ...
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Collection the list of customer balance transactions
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\CustomerBalanceTransaction
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\AlipayAccount|\BooklyStripe\Lib\Payment\Lib\Stripe\BankAccount|\BooklyStripe\Lib\Payment\Lib\Stripe\BitcoinReceiver|\BooklyStripe\Lib\Payment\Lib\Stripe\Card|\BooklyStripe\Lib\Payment\Lib\Stripe\Source
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Collection the list of tax ids
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\TaxId
     */
