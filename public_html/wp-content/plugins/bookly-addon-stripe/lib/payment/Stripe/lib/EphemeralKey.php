...
class EphemeralKey extends ApiResource
{
     ...
     *
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\EphemeralKey the created key
     */
