 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $ach_debit
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $acss_debit
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $alipay
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $au_becs_debit
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $bancontact
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $card
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $card_present
 * @property string $client_secret The client secret of the source. Used for client-side retrieval using a publishable key.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $code_verification
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $eps
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $giropay
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $ideal
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $klarna
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $multibanco
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $p24
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $receiver
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $redirect
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $sepa_credit_transfer
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $sepa_debit
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $sofort
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $source_order
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $three_d_secure
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Source the detached source
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Collection the list of source transactions
     */
