 ...
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $business_profile Business information about the account.
 * @property null|string $business_type The business type.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $capabilities
 * @property bool $charges_enabled Whether the account can create live charges.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $company
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\Collection $external_accounts External accounts (bank accounts and debit cards) currently attached to this account
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\Person $individual <p>This is an object representing a person associated with a Stripe account.</p><p>Related guide: <a href="https://stripe.com/docs/connect/identity-verification-api#person-information">Handling Identity Verification with the API</a>.</p>
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $requirements
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $settings Options for customizing how the account functions within Stripe.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $tos_acceptance
...
class Account extends ApiResource
{
     ...
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Account
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject object containing the response from the API
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Collection the list of persons
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Collection the list of capabilities
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Capability
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Collection the list of external accounts (BankAccount or Card)
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\BankAccount|\BooklyStripe\Lib\Payment\Lib\Stripe\Card
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\LoginLink
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Person
     */
