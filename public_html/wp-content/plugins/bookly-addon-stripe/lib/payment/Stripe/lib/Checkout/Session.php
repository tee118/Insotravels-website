 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject[] $display_items The line items, plans, or SKUs purchased by the customer. Prefer using <code>line_items</code>.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\Collection $line_items The line items purchased by the customer.
 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
...
class Session extends \BooklyStripe\Lib\Payment\Lib\Stripe\ApiResource
{
    ...
    use \BooklyStripe\Lib\Payment\Lib\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Collection the list of items
     */
