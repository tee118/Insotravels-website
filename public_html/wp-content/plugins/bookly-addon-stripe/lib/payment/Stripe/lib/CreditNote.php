 ...
 * @property string|\BooklyStripe\Lib\Payment\Lib\Stripe\Customer $customer ID of the customer.
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property string|\BooklyStripe\Lib\Payment\Lib\Stripe\Invoice $invoice ID of the invoice.
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\BooklyStripe\Lib\Payment\Lib\Stripe\Refund $refund Refund related to this credit note.
 ...
 * @property \BooklyStripe\Lib\Payment\Lib\Stripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\CreditNote the previewed credit note
     */
     ...
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Collection the list of credit note line items
     */
